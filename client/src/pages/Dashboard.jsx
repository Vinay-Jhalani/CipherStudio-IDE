            ...
            <form onSubmit={handleCreateProject}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 bg-[#2a2a2a] border border-gray-600 text-white rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <div className="grid grid-cols-2 gap-3">
                  {templates.map((template) => (
                    <button
                      ...
                      disabled={template.disabled || isCreatingProject}
                      className={`p-4 border-2 rounded-lg text-left transition ${
                        template.disabled || isCreatingProject
